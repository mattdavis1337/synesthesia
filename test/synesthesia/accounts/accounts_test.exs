defmodule Synesthesia.AccountsTest do
  use Synesthesia.DataCase

  alias Synesthesia.Accounts

  describe "users" do
    alias Synesthesia.Accounts.User
  ...
  describe "credentials" do
    alias Synesthesia.Accounts.Credential
